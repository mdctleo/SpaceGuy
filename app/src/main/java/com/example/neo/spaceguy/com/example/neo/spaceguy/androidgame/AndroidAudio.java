...
import com.example.neo.spaceguy.com.example.neo.spaceguy.interfaces.Audio;
...
public class AndroidAudio implements Audio {
    ...
    public Sound newSound(String filename) {
        try {
            AssetFileDescriptor assetDescriptor = assets.openFd(filename); int soundId=soundPool.load(assetDescriptor, 0);
